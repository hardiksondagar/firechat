...
exports.FB_URL   = 'https://tipandtrip.firebaseio.com/';
...
//  exports.FB_TOKEN = process.env.FB_TOKEN || null;
 exports.FB_TOKEN = 'TzuQBGybOxhrojqyqp3eu5pIyrDglgG8WrtckdMg';
...
if( process.env.BONSAI_URL ) {
   ...
   exports.ES_USER  = process.env.ES_USER || 'hardikmsondagar@gmail.com';

   // ElasticSearch password for http auth
   exports.ES_PASS  = process.env.ES_PASS || '123123';
}
